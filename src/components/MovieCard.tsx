    ...
    <>
      <div className="group bg-zinc-900 col-span relative h-[12vw]">
        <Image
          ...
          alt="movie"
          draggable={false}
          className="object-cover transition duration-100 shadow-xl rounded-md group-hover:opacity-90 sm:group-hover:opacity-0 delay-300 w-full h-full"
        />
        <div className="opacity-0 absolute top-0 transition duration-200 z-10 invisible sm:visible delay-300 w-full scale-0 group-hover:opacity-100 group-hover:scale-110 group-hover:-translate-y-[6vw] group-hover:translate-x-[2vw]">
          <Image
            width={400}
            height={100}
            src={movieData.thumbnailUrl}
            alt="movie"
            draggable={false}
            className="object-cover transition shadow-xl rounded-t-md w-full h-[12vw]"
          />
